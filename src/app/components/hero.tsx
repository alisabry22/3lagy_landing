...
export default function Hero() {
    ...
    return (
        <div className="flex justify-center px-5 py-3 text-center items-center  mx-auto  bg-primary  ">
            <div className="block mt-10 mx-auto">

                    
            <motion.h1 animate={{opacity:1}} initial={{opacity:0}} transition={{duration:0.3}} className="text-4xl text-white text-center fond-bold">3lagy</motion.h1>
            ...
            <Image src={'/3lagy_mockup.png'} className="mx-auto" alt="3lagy" width={250} height={150}></Image>
